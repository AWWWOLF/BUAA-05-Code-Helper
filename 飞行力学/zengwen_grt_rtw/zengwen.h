...
#ifndef RTW_HEADER_zengwen_h_
#define RTW_HEADER_zengwen_h_
#include <stddef.h>
#include <float.h>
#include <string.h>
#ifndef zengwen_COMMON_INCLUDES_
# define zengwen_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#include "rt_logging.h"
#endif                                 /* zengwen_COMMON_INCLUDES_ */

#include "zengwen_types.h"
...
struct P_zengwen_T_ {
  ...
  real_T ini_state_LON[4];             /* Variable: ini_state_LON
                                        ...
                                        *   '<Root>/LON'
                                        */
  real_T k_alpha_Gain;                 /* Expression: 0.391
...
struct tag_RTM_zengwen_T {
  const char_T *errorStatus;
  RTWLogInfo *rtwLogInfo;
  RTWSolverInfo solverInfo;
  X_zengwen_T *contStates;
...
extern P_zengwen_T zengwen_P;

/* Block signals (default storage) */
extern B_zengwen_T zengwen_B;

/* Continuous states (default storage) */
extern X_zengwen_T zengwen_X;

/* Block states (default storage) */
extern DW_zengwen_T zengwen_DW;

/* Model entry point functions */
extern void zengwen_initialize(void);
extern void zengwen_step(void);
extern void zengwen_terminate(void);

/* Real-time Model object */
extern RT_MODEL_zengwen_T *const zengwen_M;
